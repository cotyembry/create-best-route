...
export default class SmartTouchyImage extends React.Component {
	constructor(props) {
		...
		*/
		...
		this.state = {
			askedUserForNumber: this.props.askedUserForNumber,
	...
	componentDidMount() {
		...
		// this.setHtmlAndBodyWidthAndHeight();
		// $(window).resize(() => {
		// 	this.setHtmlAndBodyWidthAndHeight();
		// });
	}
...
class FoggyOverlay extends React.Component {
	/**
	 * 
	 * see the `onMouseUp` method for when the section is converted to crop the image
	 * 
	 */
	constructor(props) {
		super(props);
