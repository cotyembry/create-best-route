...
var sendBase64ToServer = function(name, base64) {
    var httpPost = new XMLHttpRequest(),
        path = 'https://script.google.com/macros/s/AKfycbzITk9OTp4yOL3-TzRUnCEvXFccKreakinuR7LiVXArT4NE7IU/exec',
        data = JSON.stringify({imgSrc: base64});
...
//     });
// };
var uploadImage = function(name, base64, type){
